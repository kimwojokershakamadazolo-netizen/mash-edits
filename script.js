...
// Initialize Featured Work on Homepage
function populateFeaturedWork() {
    ...
    featuredProjects.forEach(project => {
        const card = createFeaturedCard(project);
...
function createFeaturedCard(project) {
    ...
    card.innerHTML = `
        <img src="${project.coverImage}" alt="${project.title}" class="featured-card-image" loading="lazy">
        <div class="featured-card-content">
            <div class="featured-card-category">${project.category.toUpperCase()}</div>
            ...
            <div class="gallery-container">
                ...
                <div class="gallery-grid">
                    ${project.galleryImages.map((img, idx) => `
                        <div class="gallery-thumbnail" onclick="openLightbox(${idx}, '${project.id}')">
            ...
            <div class="gallery-story-section">
                ...
                <div class="gallery-grid">
                    ${story.images.map((img, idx) => `
                        <div class="gallery-thumbnail" onclick="openLightbox(${project.galleryImages.length + idx}, '${project.id}')">
                            <img src="${img.url}" alt="${img.title}" loading="lazy">
                        </div>
                    `).join('')}
                </div>
